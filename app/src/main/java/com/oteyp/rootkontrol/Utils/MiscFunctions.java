...
package com.oteyp.rootkontrol.Utils;
...
import com.oteyp.rootkontrol.MainActivity;
import com.oteyp.rootkontrol.R;
	...
	public static void rateOnPS() {
		...
		try {
			intent = new Intent(Intent.ACTION_VIEW,
					Uri.parse("market://details?id=com.oteyp.rootkontrol"));
			activity.startActivity(intent);
		} catch (ActivityNotFoundException e) {
			intent = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("https://play.google.com/store/apps/details?id=com.oteyp.rootkontrol"));
			activity.startActivity(intent);
		} catch (Exception ex) {
